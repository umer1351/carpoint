...
class CustomerController extends Controller
{
    ...
    public function dashboard() {
        ...
        return response()->json(["success" => true, "message" => "dashboard executed successfully."]);
    }
    ...
    public function otp() {
        ...
        return response()->json(["success" => true, "message" => "otp executed successfully."]);
    }
    ...
    public function update_profile() {
        ...
        $page_other_item = PageOtherItem::where('id',1)->first();
        $g_setting = GeneralSetting::where('id', 1)->first();
        return response()->json(["success" => true, "message" => "update_profile executed successfully."]);
    }
    ...
    public function update_password() {
        $g_setting = GeneralSetting::where('id', 1)->first();
        $page_other_item = PageOtherItem::where('id',1)->first();
        return response()->json(["success" => true, "message" => "update_password executed successfully."]);
    }
    ...
    public function update_photo() {
        ...
        $page_other_item = PageOtherItem::where('id',1)->first();
        return response()->json(["success" => true, "message" => "update_photo executed successfully."]);
    }
    ...
    public function update_banner() {
        ...
        $g_setting = DB::table('general_settings')->where('id', 1)->first();
        $page_other_item = PageOtherItem::where('id',1)->first();
        return response()->json(["success" => true, "message" => "update_banner executed successfully."]);
    }
    ...
    public function package() {
        ...
        return response()->json(["success" => true, "message" => "package executed successfully."]);
    }
    ...
    public function review_edit($id) {
        ...
        return response()->json(["success" => true, "message" => "review_edit executed successfully."]);
    }
    ...
    public function purchase_history() {
        ...
        $package_purchase = PackagePurchase::with('rPackage')
            ...
            ->orderBy('id', 'desc')
            ->get();
        return response()->json(["success" => true, "message" => "purchase_history executed successfully."]);
    }
    ...
    public function buy_package($id) {
        ...
        return response()->json(["success" => true, "message" => "buy_package executed successfully."]);
    }
