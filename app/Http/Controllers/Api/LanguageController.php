...
class LanguageController extends Controller
{
    ...
    public function language_menu_text() {
        ...
        return response()->json(["success" => true, "message" => "language_menu_text executed successfully."]);
    }
    ...
    public function language_website_text() {
        ...
        return response()->json(["success" => true, "message" => "language_website_text executed successfully."]);
    }
    ...
    public function language_notification_text() {
        ...
        return response()->json(["success" => true, "message" => "language_notification_text executed successfully."]);
    }
    ...
    public function language_admin_panel_text() {
        ...
        return response()->json(["success" => true, "message" => "language_admin_panel_text executed successfully."]);
    }
